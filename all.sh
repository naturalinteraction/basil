:'
./go.sh -r RoutineCurves -p redshift-sanbiagio1
./go.sh -r RoutineCurves -p noir-sanbiagio1
./go.sh -r RoutineCurves -p blueshift-sanbiagio1

./go.sh -r RoutineCurves -p redshift-callalta
./go.sh -r RoutineCurves -p noir-callalta
./go.sh -r RoutineCurves -p visible-callalta
./go.sh -r RoutineCurves -p blueshift-callalta

./go.sh -r RoutineCurves -p redshift-doublecalib
...
./go.sh -r RoutineCurves -p visible-ceppi
./go.sh -r RoutineCurves -p blueshift-ceppi
