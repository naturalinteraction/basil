...
def RoutineSenape(image_file, bgr, box):
    ...
    segmentation_threshold = 48.0
    # print(senape_hsv, senape_stddev, senape_variance, weight_hsv)
    biomass_mask = SegmentBiomass(hsv, senape_hsv, weight_hsv, segmentation_threshold)
    ...
    # before inverting it
    # we assumed in Segment() that all the edges are black (0); this way they will be inverted and become foreground!
